<div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
    ...
    <div class="card-body p-0 me-lg-5">
        <p class="fw-500 text-grey-500 lh-26 font-xssss w-100">Lorem ipsum dolor sit amet,
            ...
            nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus <a href="#"
                class="fw-600 text-primary ms-2">See more</a></p>
    </div>
    <div class="card-body d-block p-0">
        <div class="row ps-2 pe-2">
            <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset('images/t-10.jpg') }}" data-lightbox="roadtrip"><img
                        src="{{ asset('images/t-10.jpg') }}" class="rounded-3 w-100" alt="image"></a></div>
            <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset('images/t-11.jpg') }}" data-lightbox="roadtrip"><img
                        src="{{ asset('images/t-11.jpg') }}" class="rounded-3 w-100" alt="image"></a></div>
            <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset('images/t-12.jpg') }}" data-lightbox="roadtrip"
                    class="position-relative d-block"><img src="{{ asset('images/t-12.jpg') }}" class="rounded-3 w-100"
...
<div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
    ...
    <div class="card-body d-block p-0 mb-3">
        <div class="row ps-2 pe-2">
            <div class="col-xs-6 col-sm-6 p-1"><a href="{{ asset('images/t-36.jpg') }}" data-lightbox="roadtri"><img
                        src="{{ asset('images/t-21.jpg') }}" class="rounded-3 w-100" alt="image"></a></div>
            <div class="col-xs-6 col-sm-6 p-1"><a href="{{ asset('images/t-32.jpg') }}" data-lightbox="roadtri"><img
                        src="{{ asset('images/t-22.jpg') }}" class="rounded-3 w-100" alt="image"></a></div>
        </div>
        <div class="row ps-2 pe-2">
            <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset('images/t-33.jpg') }}" data-lightbox="roadtri"><img
                        src="{{ asset('images/t-23.jpg') }}" class="rounded-3 w-100" alt="image"></a></div>
            <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset('images/t-34.jpg') }}" data-lightbox="roadtri"><img
                        src="{{ asset('images/t-24.jpg') }}" class="rounded-3 w-100" alt="image"></a></div>
            <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset('images/t-35.jpg') }}" data-lightbox="roadtri"
                    class="position-relative d-block"><img src="{{ asset('images/t-25.jpg') }}"
