<div class="nav-header bg-white shadow-xs border-0" style="width: 100%; display: flex; justify-content: space-between;">
    ...
    <form action="/search" class="float-left header-search">
        <div class="form-group mb-0 icon-input">
            ...
            <input type="text" placeholder="{{ __('texts.texts.search_something') }}"
    ...
    <div style="display: flex; align-items: center;">
        <a href="#" class="p-2 text-center menu-icon" id="dropdownNotifications" data-bs-toggle="dropdown"
            aria-expanded="false"><span class="dot-count bg-warning"></span><i
                class="feather-bell font-xl text-current"></i></a>
        <div class="dropdown-menu dropdown-menu-end p-4 rounded-3 border-0 shadow-lg" aria-labelledby="dropdownNotifications">
