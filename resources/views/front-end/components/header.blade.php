...
{{--    <a href="shop-2.html" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-shopping-bag font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i></a>--}}
    ...
    <div style="display: flex; align-items: center;">
        <a href="#" class="p-2 text-center menu-icon" id="dropdownMenu3" data-bs-toggle="dropdown" aria-expanded="false"><span class="dot-count bg-warning"></span><i class="feather-bell font-xl text-current"></i></a>
        ...
        <a href="{{ route('chat') }}" class="p-2 text-center ms-3 menu-icon chat-active-btn"><i class="feather-message-square font-xl text-current"></i></a>
        ...
        <a href="default-settings.html" class="p-0 ms-3 menu-icon"><img src="{{asset("images/profile-4.png")}}" alt="user" class="w40 mt--1"></a>
    </div>
</div>
