...
{{--                        <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <a href="register.html" class="fw-700 ms-1">Register</a></h6>--}}
                    ...
                    <div class="col-sm-12 p-0 text-center mt-2">
                        ...
                        <div class="form-group mb-1">
                            <a href="{{route('login.google')}}" class="form-control text-left style2-input text-white fw-600 bg-facebook border-0 p-0 mb-2" >
...
<!-- Mirrored from uitheme.net/sociala/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jul 2023 01:21:08 GMT -->
</html>
