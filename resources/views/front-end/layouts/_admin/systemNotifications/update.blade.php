...
@push('js_page')
    <script>
        ...
        content.setData(`{!! $systemNotification->content !!}`);
        content_en.setData(`{!! $systemNotification->content_en !!}`);
    </script>
@endpush
                    ...
                    <div class="col-12 p-5 bg-white rounded-xxl">
                        <div class="plan_header">
                            ...
                            <div class="mt-3">
                                ...
                                <form action="/admin/notifications/{{ $systemNotification->id }}/update" method="POST"
                                    class="row" autocomplete="off">
                                    @csrf
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control"
                                            value="{{ $systemNotification->title }}" required>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <label for="active">
                                        ...
                                        <input type="checkbox" id="active" name="active" value="active"
                                            <?php if($systemNotification->active) { ?>checked<?php } ?>>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <label for="content">
