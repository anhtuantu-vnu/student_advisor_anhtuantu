                    ...
                    <div class="col-xl-12">
                        <div class="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                            <div class="card-body d-flex align-items-center p-0">
                                ...
                                <a href="#" class="btn-round-md ms-2 bg-greylight theme-dark-bg rounded-3"><i class="feather-plus font-xss text-grey-500"></i></a>
                            </div>
                        </div>
...
{{--                            <div class="col-md-6 col-sm-6 pe-2 ps-2">--}}
{{--                                <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">--}}
{{--                                    <div class="card-body position-relative h100 bg-image-cover bg-image-center" style="background-image: url({{ asset("images/e-4.jpg") }});"></div>--}}
{{--                                    <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">--}}
{{--                                        <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img src="{{ asset("images/user_1.png") }}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>--}}
{{--                                        <div class="clearfix"></div>--}}
