                            ...
                            <div class="card-body d-flex align-items-center p-0 mb-3">
                                <div class="plan_header">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        @if($dataPlan['data']['in_progress'])
                                            <div class="item-status">
                                                <span
                                                    class="status-number">{{ $dataPlan['data']['in_progress'] }}</span>
                                                <span class="status-type">In Progress</span>
                                            </div>
                                        @endif
                                        @if($dataPlan['data']['in_active'])
                                            <div class="item-status">
                                                <span class="status-number">{{ $dataPlan['data']['in_active'] }}</span>
                                                <span class="status-type">In Active</span>
                                            </div>
                                        @endif
                                        @if($dataPlan['data']['complete'])
                                            <div class="item-status">
                                                <span class="status-number">{{ $dataPlan['data']['complete'] }}</span>
                                                <span class="status-type">Complete</span>
                                            </div>
                                        @endif
                                        @if($dataPlan['data']['complete'])
                                            <div class="item-status">
                                                <span class="status-number">{{ $dataPlan['data']['total_plan'] }}</span>
