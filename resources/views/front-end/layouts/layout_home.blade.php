                ...
                <div class="row feed-body">
                    <div class="col-xl-8 col-xxl-9 col-lg-8">
                            ...
                            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                                ...
                                <div class="item">
                                    <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                         ...
                                         style="background-image: url( {{asset("images/s-1.jpg")}} );">
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#">
                                                <figure
                                                    class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1">
                                                    <img src="{{ asset("images/user-11.png") }}" alt="image"
                                ...
                                <div class="item">
                                    <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                         class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3"
                                         style="background-image: url( {{asset("images/s-2.jpg")}} );">
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#">
                                                <figure
                                                    class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1">
                                                    <img src="{{ asset("images/user-12.png") }}" alt="image"
                                                         class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                                </figure>
                                                <div class="clearfix"></div>
                                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                ...
                                <div class="item">
                                    <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                        ...
                                        <video autoplay loop class="float-right w-100">
                                            <source src="{{ asset("images/s-4.mp4") }}" type="video/mp4">
                                        </video>
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#">
                                                <figure
                                ...
                                <div class="item">
                                    <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                        ...
                                        <video autoplay loop class="float-right w-100">
                                            <source src="{{ asset("images/s-3.mp4") }}" type="video/mp4">
                                        </video>
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#">
                                                <figure
                                                    class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1">
                                                    <img src="{{asset("images/user-4.png")}}" alt="image"
                                                         class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                                </figure>
                                                <div class="clearfix"></div>
                                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                ...
                                <div class="item">
                                    <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                         class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3"
                                         style="background-image: url({{asset("images/s-5.jpg")}});">
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#">
                                                <figure
                                                    class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1">
                                                    <img src="{{asset("images/user-3.png")}}" alt="image"
                                                         class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                                </figure>
                                                <div class="clearfix"></div>
                                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                                ...
                                <div class="item">
                                    <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                         class="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden cursor-pointer mb-3 mt-3"
                                         style="background-image: url({{ asset("images/s-6.jpg") }});">
                                        <div class="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                                            <a href="#">
                                                <figure
                                                    class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1">
                                                    <img src="{{ asset("images/user-2.png") }}" alt="image"
                                                         class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                                </figure>
                                                <div class="clearfix"></div>
                                                <h4 class="fw-600 position-relative z-index-1 ls-1 font-xssss text-white mt-2 mb-1">
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
                            ...
                            <div class="card-body p-0 mt-3 position-relative">
                                <figure class="avatar position-absolute ms-2 mt-1 top-5"><img
                                        src="{{ asset("images/user-8.png") }}" alt="image"
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                            ...
                            <div class="card-body d-block p-0">
                                <div class="row ps-2 pe-2">
                                    <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset("images/t-10.jpg") }}"
                                                                          data-lightbox="roadtrip"><img
                                                src="{{ asset("images/t-10.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                    <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset("images/t-11.jpg") }}"
                                                                          data-lightbox="roadtrip"><img
                                                src="{{ asset("images/t-11.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                    <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset("images/t-12.jpg") }}"
                                                                          data-lightbox="roadtrip"
                                                                          class="position-relative d-block"><img
                                                src="{{ asset("images/t-12.jpg") }}" class="rounded-3 w-100"
                                                alt="image"><span
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                            <div class="card-body p-0 d-flex">
                                <figure class="avatar me-3 m-0"><img src="{{ asset("images/user-8.png") }}" alt="image"
                                                                     class="shadow-sm rounded-circle w45"></figure>
                            ...
                            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                                <div class="item">
                                    <div
                                        ...
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/u-bg.jpg") }});"></div>
                                ...
                                <div class="item">
                                    <div
                                        class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/s-2.jpg") }});"></div>
                                        <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                            <figure
                                                class="avatar ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1">
                                                <img src="{{ asset("images/user-2.png") }}" alt="image"
                                ...
                                <div class="item">
                                    <div
                                        class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/s-6.jpg") }});"></div>
                                        <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                            <figure
                                                class="avatar ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1">
                                                <img src="{{ asset("images/user-3.png") }}" alt="image"
                                ...
                                <div class="item">
                                    <div
                                        class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/bb-16.png") }});"></div>
                                        <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                            <figure
                                                class="avatar ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1">
                                                <img src="{{ asset("images/user-4.png") }}" alt="image"
                                ...
                                <div class="item">
                                    <div
                                        class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/e-4.jpg") }});"></div>
                                        <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                            <figure
                                                class="avatar ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1">
                                ...
                                <div class="item">
                                    <div
                                        class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/coming-soon.png") }});"></div>
                                        <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                            <figure
                                                class="avatar ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1">
                                                <img src="{{ asset("images/user-5.png") }}" alt="image"
                                                     class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
                                ...
                                <div class="item">
                                    <div
                                        class="card w200 d-block border-0 shadow-xss rounded-xxl overflow-hidden mb-3 me-2 mt-3">
                                        <div class="card-body position-relative h100 bg-image-cover bg-image-center"
                                             style="background-image: url({{ asset("images/bb-9.jpg") }});"></div>
                                        <div class="card-body d-block w-100 ps-4 pe-4 pb-4 text-center">
                                            <figure
                                                class="avatar ms-auto me-auto mb-0 mt--6 position-relative w75 z-index-1">
                                                <img src="{{ asset("images/user-6.png") }}" alt="image"
                                                     class="float-right p-1 bg-white rounded-circle w-100"></figure>
                                            <div class="clearfix"></div>
                                            <h4 class="fw-700 font-xsss mt-2 mb-1">Mohannad Zitoun </h4>
                                            <p class="fw-500 font-xsssss text-grey-500 mt-0 mb-2">support@gmail.com</p>
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                            <div class="card-body p-0 d-flex">
                                <figure class="avatar me-3"><img src="{{ asset("images/user-8.png") }}" alt="image"
                                                                 class="shadow-sm rounded-circle w45"></figure>
                            ...
                            <div class="card-body p-0 mb-3 rounded-3 overflow-hidden">
                                <a href="default-video.html" class="video-btn">
                                    <video autoplay loop class="float-right w-100">
                                        <source src="{{ asset("images/v-2.mp4") }}" type="video/mp4">
                                    </video>
                                </a>
                            </div>
                            <div class="card-body p-0 me-lg-5">
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                            ...
                            <div class="card-body d-block p-0 mb-3">
                                <div class="row ps-2 pe-2">
                                    <div class="col-xs-6 col-sm-6 p-1"><a href="{{ asset("images/t-36.jpg") }}"
                                                                          data-lightbox="roadtri"><img
                                                src="{{ asset("images/t-21.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                    <div class="col-xs-6 col-sm-6 p-1"><a href="{{ asset("images/t-32.jpg") }}"
                                                                          data-lightbox="roadtri"><img
                                                src="{{ asset("images/t-22.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                </div>
                                <div class="row ps-2 pe-2">
                                    <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset("images/t-33.jpg") }}"
                                                                          data-lightbox="roadtri"><img
                                                src="{{ asset("images/t-23.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                    <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset("images/t-34.jpg") }}"
                                                                          data-lightbox="roadtri"><img
                                                src="{{ asset("images/t-24.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                    <div class="col-xs-4 col-sm-4 p-1"><a href="{{ asset("images/t-35.jpg") }}"
                                                                          data-lightbox="roadtri"
                                                                          class="position-relative d-block"><img
                                                src="{{ asset("images/t-25.jpg") }}" class="rounded-3 w-100"
                                                alt="image"><span
                                                class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                                    </div>
                                </div>
                            ...
                            <div class="owl-carousel category-card owl-theme overflow-hidden nav-none">
                                ...
                                <div class="item">
                                    <div
                                        ...
                                        <div class="card-body d-block w-100 ps-3 pe-3 pb-4 text-center">
                                            <figure class="avatar ms-auto me-auto mb-0 position-relative w65 z-index-1">
                                                <img src="{{ asset("images/user-8.png") }}" alt="image"
                                                     class="float-right p-0 bg-white rounded-circle w-100 shadow-xss">
                                            </figure>
                                            <div class="clearfix"></div>
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                            ...
                            <div class="card-body p-0 mb-3 rounded-3 overflow-hidden">
                                <a href="default-video.html" class="video-btn">
                                    <video autoplay loop class="float-right w-100">
                                        <source src="{{ asset("images/v-1.mp4") }}" type="video/mp4">
                                    </video>
                                </a>
                            </div>
                            <div class="card-body p-0 me-lg-5">
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                            ...
                            <div class="card-body d-block p-0 mb-3">
                                <div class="row ps-2 pe-2">
                                    <div class="col-sm-12 p-1"><a href="{{ asset("images/t-30.jpg") }}"
                                                                  data-lightbox="roadtr"><img
                                                src="{{ asset("images/t-31.jpg") }}" class="rounded-3 w-100"
                                                alt="image"></a></div>
                                </div>
                            </div>
                            <div class="card-body d-flex p-0">
                    ...
                    <div class="col-xl-4 col-xxl-3 col-lg-4 ps-lg-0">
                        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                            ...
                            <div class="card-body d-flex pt-0 ps-4 pe-4 pb-0">
                                <figure class="avatar me-3"><img src="{{ asset("images/user-12.png") }}" alt="image"
                                                                 class="shadow-sm rounded-circle w45"></figure>
                                <h4 class="fw-700 text-grey-900 font-xssss mt-1">Mohannad Zitoun <span
                                        class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual friends</span>
                                </h4>
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-0 ">
                            ...
                            <div class="card-body bg-transparent-card d-flex p-3 bg-greylight ms-3 me-3 rounded-3">
                                <figure class="avatar me-2 mb-0"><img src="{{ asset("images/user-7.png") }}" alt="image"
                                                                      class="shadow-sm rounded-circle w45"></figure>
                            ...
                            <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3"
                                ...
                                <figure class="avatar me-2 mb-0"><img src="{{ asset("images/user-8.png") }}" alt="image"
                                                                      class="shadow-sm rounded-circle w45"></figure>
                            ...
                            <div class="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3">
                                <figure class="avatar me-2 mb-0"><img src="{{ asset("images/user-12.png") }}"
                        ...
                        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                            ...
                            <div class="card-body d-flex pt-0 ps-4 pe-4 pb-0 overflow-hidden">
                                <img src="{{ asset("images/g-3.jpg") }}" alt="img"
